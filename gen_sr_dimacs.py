...
if __name__ == "__main__":
    ...
    parser.add_argument('n_pairs', action='store', type=int, help='Total number of SAT/UNSAT pairs to generate.')
    
    parser.add_argument('--sat', action='store_true', dest='store_sat', help='Generate SAT problems.')
    parser.add_argument('--unsat', action='store_true', dest='store_unsat', help='Generate UNSAT problems.')
    parser.add_argument('--min_n', action='store', dest='min_n', type=int, default=40, help='Minimum number of variables.')
    parser.add_argument('--max_n', action='store', dest='max_n', type=int, default=40, help='Maximum number of variables.')

    parser.add_argument('--p_k_2', action='store', dest='p_k_2', type=float, default=0.3, help='Controls size of each clause by specifying probability for a Bernoulli distribution.')
    parser.add_argument('--p_geo', action='store', dest='p_geo', type=float, default=0.4, help='Controls size of each clause by specifying probability for a Geometric distribution.')
